...
function Login() {
  ...
  return (
    <div className="min-h-screen">
      <div className={`max-w-full h-screen container mx-auto  space-y-2 rounded-lg border bg-gradient-to-bl from-blue-400 to-blue-50  dark:border-none p-8 shadow-md  dark:bg-metal-800 dark:from-metal-800 dark:to-metal-900`}>
       
        
        <div className=" md:flex gap-2 ">
          <div>
            <img
              className={`w-full rounded object-cover ${theme === "dark"? "dark:bg-gray-700" : "bg-white"}`}
...
<p className="w-[70%] mx-auto">We're pleased to have you return to our task management platform. To continue managing your tasks efficiently and effectively, please log in using your credentials.
     </p>
          <Button
